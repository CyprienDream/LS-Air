-- This query finds which are the airlines and the number of routes that have a
-- plane whose maximum capacity is lower than the minimum petrol required to fly the route.
-- Only the routes between different countries are being considered.
